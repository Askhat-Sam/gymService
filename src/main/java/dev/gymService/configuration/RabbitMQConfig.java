...
public class RabbitMQConfig {
    ...
    // Spring bean for rabbitmq exchange type of Direct
    @Bean
    ...
    // Binding for summary request queue and exchange using routing key summaryRequestRoutingKey
    @Bean
    ...
    //Providing custom mapping from the value in the TypeId header
    @Bean
    public DefaultClassMapper classMapper() {
        DefaultClassMapper classMapper = new DefaultClassMapper();
        Map<String, Class<?>> idClassMapping = new HashMap<>();
        idClassMapping.put("dev.workload.microservice.model.TrainingWorkload", dev.gymService.model.TrainingWorkload.class);
